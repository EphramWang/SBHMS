...
/**
 * Created by ning on 17/3/30.
 */

public interface ITouchable {

    void onScroll(float newX, float newY, float oldX, float oldY);
    void onScale(float scaleX, float scaleY, float pointX, float pointY);

    void onLongPressDown(float x, float y);
